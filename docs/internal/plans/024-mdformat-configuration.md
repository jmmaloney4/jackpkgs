...
This plan outlines the steps to implement the changes described in [ADR-024](../decisions/024-mdformat-configuration.md) and [Issue #148](https://github.com/jmmaloney4/jackpkgs/issues/148).
